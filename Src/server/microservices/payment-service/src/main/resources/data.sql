...
('STUDENT_MONTHLY', 'Gói Học Sinh', 'Dành cho sinh viên, giá ưu đãi', 49000, 'vnd', 1, 'price_1Sx51IDF8r7KM60qBxyUODsi', true),
('PREMIUM_MONTHLY', 'Premium Tháng', 'Xem phim không giới hạn, không quảng cáo', 99000, 'vnd', 1, 'price_1Sx4wHDF8r7KM6OqZ9W4Jkcv', true),
('PREMIUM_QUARTERLY', 'Premium Quý', 'Gói 3 tháng tiết kiệm', 249000, 'vnd', 3, 'price_1Sx533DF8r7KM60qxrjM7QS5', true),
('PREMIUM_YEARLY', 'Premium Năm', 'Xem phim không giới hạn, tiết kiệm 20%', 948000, 'vnd', 12, 'price_1Sx53pDF8r7KM60qXgNAWxxK', true),
